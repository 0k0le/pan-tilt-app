...
Layout::Layout(Recorder* recorder, QLabel* parent, const char* const bbgIp) : QObject(parent) {
    client = std::make_unique<Client>(bbgIp);

    _recorder = recorder;

    // Setup labels
    xRotationLabel = std::make_unique<QLabel>(parent);
    xRotationLabel->setGeometry(RESX + 20, 10, 100, 20);
    xRotationLabel->setText("Horizontal Axis");
    xRotationLabel->show();

    // Setup sliders
    xRotationSlider = std::make_unique<QSlider>(Qt::Horizontal, parent);
    ...
    // Setup labels
    yRotationLabel = std::make_unique<QLabel>(parent);
    yRotationLabel->setGeometry(RESX + 20, 100, 100, 20);
    yRotationLabel->setText("Vertical Axis");
    yRotationLabel->show();

    // Setup sliders
    yRotationSlider = std::make_unique<QSlider>(Qt::Horizontal, parent);
    ...
    // Vertical Sliders
    focusSlider = std::make_unique<QSlider>(Qt::Vertical, parent);
    ...
    // Vertical Sliders
    zoomSlider = std::make_unique<QSlider>(Qt::Vertical, parent);
    ...
    // Vertical Sliders
    apertureSlider = std::make_unique<QSlider>(Qt::Vertical, parent);
    ...
    // Vertical Sliders
    exposureSlider = std::make_unique<QSlider>(Qt::Vertical, parent);
    ...
    // Vertical Sliders
    whitebalanceSlider = std::make_unique<QSlider>(Qt::Vertical, parent);
    ...
    // Vertical Sliders
    gainSlider = std::make_unique<QSlider>(Qt::Vertical, parent);
    ...
    connect(apertureSlider.get(), &QSlider::valueChanged, this, [this]{
        dlock.lock();
    ...
    connect(zoomSlider.get(), &QSlider::valueChanged, this, [this]{
        dlock.lock();
    ...
    connect(exposureSlider.get(), &QSlider::valueChanged, this, [this]{
        _recorder->SetExposure(this->exposureSlider->value());
    });

    connect(whitebalanceSlider.get(), &QSlider::valueChanged, this, [this]{
